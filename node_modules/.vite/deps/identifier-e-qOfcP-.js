...
function compose(...styles) {
	...
	const fn = (props) => {
		return Object.keys(props).reduce((acc, prop) => {
			if (handlers[prop]) return merge$1(acc, handlers[prop](props));
			return acc;
		}, {});
	};
	...
	function styleFunctionSx(props) {
		...
		function traverse(sxInput) {
			...
			Object.keys(sxObject).forEach((styleKey) => {
				...
				if (value !== null && value !== void 0) if (typeof value === "object") if (config[styleKey]) css = merge$1(css, getThemeValue(styleKey, value, theme, config));
				else {
					...
					else css = merge$1(css, breakpointsValues);
				}
				else css = merge$1(css, getThemeValue(styleKey, value, theme, config));
			});
...
//#endregion
export { capitalize as A, mergeBreakpointsInOrder as C, require_react_is$1 as D, isPlainObject as E, clsx as O, handleBreakpoints as S, deepmerge as T, _extends as _, useRtl as a, createUnarySpacing as b, generateUtilityClasses as c, createTheme$1 as d, internal_mutateStyles as f, keyframes as g, css as h, unstable_memoTheme as i, ClassNameGenerator as j, require_prop_types as k, generateUtilityClass as l, styled as m, createTheme as n, alpha as o, internal_serializeStyles as p, getOverlayAlpha as r, preprocessStyles as s, identifier_default as t, useTheme as u, extendSxProp as v, resolveBreakpointValues as w, getValue as x, styleFunctionSx as y };

//# sourceMappingURL=identifier-e-qOfcP-.js.map